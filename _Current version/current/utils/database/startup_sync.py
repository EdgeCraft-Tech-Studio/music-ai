...
class StartupSync:
    ...
    def _find_changes(self, db_files: Dict, fs_files: Dict) -> Dict:
        ...
        for path, fs_info in fs_files.items():
            if path in db_files:
                ...
                if abs(fs_info['modified_time'] - db_info['modified_time']) > 1.0:  # 1 second tolerance
    ...
    def _log_sync_results(self):
        ...
        if self.stats['files_added'] > 0 or self.stats['files_removed'] > 0 or self.stats['files_updated'] > 0:
